...
if (isset($_POST['signup'])) {
    ...
    $signup = "INSERT INTO `buyer` (`username`,`password`,`first_name`,`last_name`,`email`,`contact_number`) VALUES ('$name', '$hashed_password','$first_name','$last_name','$email','$phone_num')";
...
<div class="container mt-3">
  ...
  <form action='register.php' method='post' name='login_form'>
    <div class="mb-3 mt-3">
      ...
      <input type="text" class="form-control" id="username" placeholder="Enter Username" name="user_signup">
    </div>
    <div class="mb-3">
